...
namespace VYS_Proje
{
    public partial class Form13 : Form
    {
        ...
        {
            if (!int.TryParse(maskedTextProgramId.Text, out int programId))
            {
                MessageBox.Show("Geçerli bir Program ID giriniz.", "Hata", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
