...
namespace VYS_Proje
{
    public partial class Form12 : Form
    {
        ...
        {
            if (!int.TryParse(maskedTextKatilimId.Text, out int katilimId))
            {
                MessageBox.Show("Geçerli bir Katılım ID giriniz.", "Hata", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
