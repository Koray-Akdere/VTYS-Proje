...
namespace VYS_Proje
{
    public partial class Form19 : Form
    {
        ...
        {
            if (!int.TryParse(maskedTextUyeEkipmanId.Text, out int uyeEkipmanId))
            {
                MessageBox.Show("Geçerli bir ÜyeEkipman ID giriniz.", "Hata", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        ...
        private void btnIdAra_Click(object sender, EventArgs e)
        {
            ...
            SELECT 
                 ...
                 kullanim_tarihi
            FROM UyeEkipman
            WHERE uye_ekipman_id = {uyeEkipmanId};"
             );
            idAra.ShowDialog();
        }
    }
