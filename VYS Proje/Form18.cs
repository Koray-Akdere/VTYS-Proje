...
namespace VYS_Proje
{
    public partial class Form18 : Form
    {
        ...
        {
            if (!int.TryParse(maskedTextSinifDersId.Text, out int sinifDersId))
            {
                MessageBox.Show("Geçerli bir SınıfDers ID giriniz.", "Hata", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        ...
        private void btnIdAra_Click(object sender, EventArgs e)
        {
            ...
            SELECT 
                ...
                ders_id
            FROM SinifDers
            WHERE sinifders_id = {sinifDersId};"
            );
            idAra.ShowDialog();
        }
    }
