...
namespace VYS_Proje
{
    public partial class Form16 : Form
    {
        ...
        {
            if (!int.TryParse(maskedTextYoklamaId.Text, out int yoklamaId))
            {
                MessageBox.Show("Geçerli bir Yoklama ID giriniz.", "Hata", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
