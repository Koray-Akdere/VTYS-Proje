...
namespace VYS_Proje
{
    public partial class Form14 : Form
    {
        ...
        {
            if (!int.TryParse(maskedTextBeslenmeId.Text, out int beslenmeId))
            {
                MessageBox.Show("Geçerli bir Beslenme ID giriniz.", "Hata", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
