...
1	Yağ Yaktıran Alet 4000	2024-01-09	Bakımda
\.
...
--
-- Name: uyeekipman triggerekipmangecerlilikkontrol; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER triggerekipmangecerlilikkontrol BEFORE INSERT ON public.uyeekipman FOR EACH ROW EXECUTE FUNCTION public.ekipmangecerlilikkontrol();


--
-- Name: sinifrezervasyon triggersinifrezervasyonkontrol; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER triggersinifrezervasyonkontrol BEFORE INSERT ON public.sinifrezervasyon FOR EACH ROW EXECUTE FUNCTION public.sinifrezervasyonkontrol();
...
ALTER TABLE ONLY public.egitmen
    ADD CONSTRAINT egitmen_kisi_id_fkey FOREIGN KEY (kisi_id) REFERENCES public.calisan(kisi_id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY public.isci
    ADD CONSTRAINT isci_kisi_id_fkey FOREIGN KEY (kisi_id) REFERENCES public.calisan(kisi_id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY public.uye
    ADD CONSTRAINT uye_kisi_id_fkey FOREIGN KEY (kisi_id) REFERENCES public.kisi(kisi_id) ON UPDATE CASCADE ON DELETE CASCADE;
